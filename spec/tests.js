...
describe('URL Corollarizer', function() { 
  ...
  beforeEach(function() {
	self = {location: {}};
	Object.defineProperty(self.location, 'href', {value: "https://v19b-content1.bl.uk/collection-guides/news-data", writable: true, configurable: true});
  });
  ...
  it('should redirect to \"www.bl.uk\" when option 1 chosen (HTTPS redirect)', function () {
  ...
  it('should redirect to \"www.bl.uk\" when option 1 chosen (HTTP redirect)', function () {
	self.location.href = "http://www.bl.uk/collection-guides/news-data";
	const rewrittenUrlCorollary =  url_corollarizer(1);
	const expected = "http://www.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  });
  it('should retain the port in the source URL as it redirects to \"www.bl.uk\" when option 1 chosen (HTTPS redirect)', function () {
	self.location.href = "https://www.bl.uk:80/collection-guides/news-data";
	const rewrittenUrlCorollary =  url_corollarizer(1);
	const expected = "https://www.bl.uk:80/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  });
  it('should retain the port in the source URL as it redirects to \"www.bl.uk\" when option 1 chosen (HTTP redirect)', function () {
	self.location.href = "http://www.bl.uk:80/collection-guides/news-data";
	const rewrittenUrlCorollary =  url_corollarizer(1);
	const expected = "http://www.bl.uk:80/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 2 BELOW
  it('should redirect to \"v19b-content1.bl.uk\" when option 2 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(2);
	const expected = "https://v19b-content1.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 3 BELOW
  it('should redirect to \"v19b-content2.bl.uk\" when option 3 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(3);
	const expected = "https://v19b-content2.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 4 BELOW
  it('should redirect to \"v19b-fe1.dmz.bl.uk\" when option 4 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(4);
	const expected = "https://v19b-fe1.dmz.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 5 BELOW
  it('should redirect to \"v19b-fe2.dmz.bl.uk\" when option 5 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(5);
	const expected = "https://v19b-fe2.dmz.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 6 BELOW
  it('should redirect to \"v19b-fenle1.dmz.bl.uk\" when option 6 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(6);
	const expected = "https://v19b-fenle1.dmz.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 7 BELOW
  it('should redirect to \"v19b-fenle2.dmz.bl.uk\" when option 7 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(7);
	const expected = "https://v19b-fenle2.dmz.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 8 BELOW
  it('should redirect to \"v19b-fenle3.dmz.bl.uk\" when option 10 chosen (HTTPS redirect)', function () {
	const rewrittenUrlCorollary =  url_corollarizer(8);
	const expected = "https://v19b-fenle3.dmz.bl.uk/collection-guides/news-data";
	expect(rewrittenUrlCorollary).toEqual(expected);
	expect(self.location.href).toEqual(expected);
  }); // OPTION 9 BELOW
  it('should redirect to \"v19b-fenle4.dmz.bl.uk\" when option 11 chosen (HTTPS redirect)', function () {
